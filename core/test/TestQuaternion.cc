...
TEST(QuaternionTest, FromEulerAngles) {
    ...
    EXPECT_NEAR(q.W, std::cos(PI / 4), 1e-5); // 0.70710678118
    EXPECT_NEAR(q.X, std::sin(PI / 4), 1e-5); // 0.70710678118
...
TEST(QuaternionTest, FromEulerAngles_Yaw) {
    ...
    EXPECT_NEAR(q.Y, std::sin(PI / 4), 1e-5); // 0.70710678118
    EXPECT_NEAR(q.Z, 0.0, 1e-5);
}
...
TEST(QuaternionTest, FromEulerAngles_Roll) {
    ...
    EXPECT_NEAR(q.X, 0.0, 1e-5);
    EXPECT_NEAR(q.Y, 0.0, 1e-5);
    EXPECT_NEAR(q.Z, std::sin(PI / 4), 1e-5); // 0.70710678118
}
